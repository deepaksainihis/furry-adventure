				...
				<div class="shopengine-table__body-item" cart_item="=">
					<div class="shopengine-table__body-item--td table-first-body-column">
						...
						<div class="product-thumbnail" data-title="Image"> 
							<a href="https://en.gravatar.com/userimage/215260729/3cb6b9fe31d9ee9112faba4c056a9d0e.jpg?size=300">
							...
							<div class="product-remove">
								<a href="javascript:void(0)" class="remove" aria-label="Remove this item" data-product_id="34" data-product_sku="Woo-beanie-logo">
					...
					<div class="shopengine-table__body-item--td product-name" data-title="Product">
						<a href="https://en.gravatar.com/userimage/215260729/3cb6b9fe31d9ee9112faba4c056a9d0e.jpg?size=300">Beanie with Logo</a>
					</div>
					<!-- product price -->
